      ...
      <div className="container px-4 py-12 mx-auto">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p>
              This Cookie Policy explains how Neuron Bright ("we," "our," or "us") uses cookies and similar technologies
            ...
            <p>
              Cookies set by the website owner (in this case, Neuron Bright) are called "first-party cookies." Cookies
